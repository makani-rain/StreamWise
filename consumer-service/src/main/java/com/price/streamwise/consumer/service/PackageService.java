...
public class PackageService {
    ...
    public List<PackageEntity> findAll() { return repo.findAll(); }
    public PackageEntity findById(UUID id) { return repo.findById(id).orElse(null); }
    public PackageEntity save(PackageEntity p) { return repo.save(p); }
